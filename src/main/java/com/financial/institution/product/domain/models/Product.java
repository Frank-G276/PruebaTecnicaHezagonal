...
public class Product {
    ...
    public Product(IdProduct idProduct, AccountType accountType, AccountNumber accountNumber, AccountState accountState, Balance balance, ExemptGMF exemptGMF, CreatedAt createdAt, UpdateAt updateAt, IdCustomer idCustomer) {
    ...
    public Product(AccountType accountType, AccountNumber accountNumber, AccountState accountState, Balance balance, ExemptGMF exemptGMF, CreatedAt createdAt, UpdateAt updateAt, IdCustomer idCustomer) {
        this.accountType = accountType;
        this.accountNumber = accountNumber;
        this.accountState = accountState;
        this.balance = balance;
