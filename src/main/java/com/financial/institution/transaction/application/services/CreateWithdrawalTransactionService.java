...
public class CreateWithdrawalTransactionService implements CreateWithdrawalTransactionUseCase {

    private final UpdateBalancesProductUseCase updateBalancesProductUseCase;
    private final TransactionRepository transactionRepository;

    public CreateWithdrawalTransactionService(UpdateBalancesProductUseCase updateBalancesProductUseCase, TransactionRepository transactionRepository) {
